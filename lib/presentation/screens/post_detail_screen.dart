...
class PostDetailPage extends StatefulWidget {
  PostDetailPage({Key key, this.model}) : super(key: key);
  final dynamic model;
  @override
  _PostDetailPageState createState() => _PostDetailPageState(model);
}

class _PostDetailPageState extends State<PostDetailPage> {
  final dynamic model;

  _PostDetailPageState(this.model);
  @override
  void initState() {
    super.initState();
  }
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Text("Post Body", style: titleStyle).vP16,
                        Text(
                          model.description,
